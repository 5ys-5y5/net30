...
export function createDraftStore(assetRoot) {
  ...
  async function create(input) {
    ...
    const value = { id, version: "net30.modeling-draft.v7", revision: 1, state: "analyzing_product", message: "제품과 입력 이미지를 분석 중입니다.", input, product: null, components: [], questions: [], stickerSlots: [], iterations: [], activeIterationId: null, progress: [], nextProgressEventId: 1, jobId: null, events: [], createdAt: now, updatedAt: now };
