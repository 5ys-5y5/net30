...
export function createDraftStore(assetRoot) {
  ...
  async function create(input) {
    ...
    const value = { id, version: "net30.modeling-draft.v8", revision: 1, state: "analyzing_product", message: "제품과 입력 이미지를 분석 중입니다.", input, product: null, components: [], questions: [], modelingGraph: null, modelingGraphV3: null, modelingGraphHash: null, evidenceManifest: null, imageEvidence: null, fit: null, qualityReport: null, productModelingFile: null, baseGraphHash: null, compilerVersion: "modeling-graph-v3", capabilityVersion: "net30-occt-v3", stickerSlots: [], iterations: [], activeIterationId: null, progress: [], nextProgressEventId: 1, jobId: null, events: [], createdAt: now, updatedAt: now };
