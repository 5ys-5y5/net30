...
const gates = qualityGates({ graphHash: canonical.graphHash, contour: { iou: .98, rmsMm: .3, hausdorff95Mm: .6 }, landmarks: { maxMm: .4 }, brep: { valid: true, closed: true, freeEdges: 0, interferenceCount: 0 }, step: { boundsDeltaMm: .009, volumeDeltaRatio: .0009 }, evidenceComplete: true });
