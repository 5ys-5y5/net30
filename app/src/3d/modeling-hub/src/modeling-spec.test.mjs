...
assert.deepEqual(normalizedModifier.graph.nodes.map((node) => node.operation), ["revolve"]);
assert.equal(normalizedModifier.graph.nodes[0].parameters.thicknessMm, 2.6);
