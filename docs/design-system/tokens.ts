...
export const CLASS = {
  ...
  modelingStudio: "ds-modeling-studio", modelingForm: "ds-modeling-form", modelingFields: "ds-modeling-fields", modelingField: "ds-modeling-field", modelingFieldWide: "ds-modeling-field-wide", modelingControl: "ds-modeling-control", modelingTextarea: "ds-modeling-textarea", modelingButton: "ds-modeling-button", modelingPreview: "ds-modeling-preview", modelingToolbar: "ds-modeling-toolbar", modelingFrame: "ds-modeling-frame", modelingResult: "ds-modeling-result", modelingError: "ds-modeling-error", modelingHint: "ds-modeling-hint", modelingChoices: "ds-modeling-choices", modelingChoice: "ds-modeling-choice", modelingComponentPrompt: "ds-modeling-component-prompt", modelingProgress: "ds-modeling-progress", modelingProgressList: "ds-modeling-progress-list", modelingProgressItem: "ds-modeling-progress-item", modelingVersionList: "ds-modeling-version-list", modelingVersion: "ds-modeling-version", modelingAction: "ds-modeling-action",
