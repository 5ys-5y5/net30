export const TEMPLATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ region: "catalog", composition: "CatalogRegion", atoms: Object.freeze(["Container", "SectionHeading", "LabeledChoice", "ProductVisual", "Metric", "KoreanSupplementLabel", "Sticker", "StickerSheet", "StickerHeader", "StickerSection", "StickerRows", "StickerField", "StickerCopy", "StickerCostRows", "StickerCostHeader", "StickerCostRow", "StickerCostGroup", "Panel", "SurfaceGrid", "GridCell", "ActionButton", "FormField", "FieldGroup", "SelectionCard", "SelectionCardControl", "ModelPreviewFrame", "AssociationList", "AssociationRow", "AssetIdentity", "ReviewWorkspace", "ReviewWorkspaceHeader", "WorkflowStepper", "WorkflowStep", "ProposalCard", "ParameterEditor", "ParameterGroup", "ParameterQuestionCard", "ParameterValue", "EvidencePreview", "ReviewStatus", "ReviewProgress", "DecisionActions", "BuildGate", "BuildProgressPanel", "ModelResultPanel", "DecisionHistoryDisclosure", "ReviewScopeNavigator", "ReviewScopeControl", "ScopedApprovalBar", "ProcessProgressPanel", "ProgressStageList", "ProgressStage"]) }),
