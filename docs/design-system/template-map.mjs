export const TEMPLATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ region: "catalog", composition: "CatalogRegion", atoms: Object.freeze(["Container", "SectionHeading", "LabeledChoice", "ProductVisual", "Metric", "KoreanSupplementLabel", "Sticker", "StickerSheet", "StickerHeader", "StickerSection", "StickerRows", "StickerField", "StickerCopy", "StickerCostRows", "StickerCostHeader", "StickerCostRow", "StickerCostGroup", "Panel", "SurfaceGrid", "GridCell", "ActionButton", "FormField", "FieldGroup", "SelectionCard", "SelectionCardControl", "ModelPreviewFrame", "AssociationList", "AssociationRow", "AssetLibraryGrid", "AssetLibraryCard", "AssetIdentity", "AssetIdentityHeader", "AssetHierarchy", "AssetHierarchyItem", "AssetNodeActions", "AssetEditContext", "InlineAssetEditor", "DestructiveActionGate", "AssetEmptyState", "ModelingWorkspaceIntro", "ModelingPreviewStage", "ModelingCatalogLayout", "ModelingStudio", "ModelingLibraryWorkspace", "ModelingLibraryTree", "ModelingOutputSections", "ReviewWorkspace", "ReviewWorkspaceHeader", "WorkflowStepper", "WorkflowStep", "ProposalCard", "ParameterEditor", "ParameterGroup", "ParameterQuestionCard", "ParameterValue", "EvidencePreview", "ReviewStatus", "ReviewProgress", "DecisionActions", "BuildGate", "BuildProgressPanel", "ModelResultPanel", "DecisionHistoryDisclosure", "ReviewScopeNavigator", "ReviewScopeControl", "ScopedApprovalBar", "ProcessProgressPanel", "ProgressStageList", "ProgressStage", "SketchReviewPanel", "SketchCanvas", "SketchAnnotationLayer", "PenToolbar", "IterationNavigator"]) }),
