export const TEMPLATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ region: "catalog", composition: "CatalogRegion", atoms: Object.freeze(["Container", "SectionHeading", "LabeledChoice", "ProductVisual", "Metric", "KoreanSupplementLabel", "Sticker", "StickerSheet", "StickerHeader", "StickerSection", "StickerRows", "StickerField", "StickerCopy", "StickerCostRows", "StickerCostHeader", "StickerCostRow", "StickerCostGroup", "Panel", "SurfaceGrid", "GridCell", "ActionButton", "FormField", "FieldGroup", "SelectionCard", "SelectionCardControl", "ModelPreviewFrame"]) }),
